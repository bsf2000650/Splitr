...
export const TESTIMONIALS = [
  {
    quote:
      "Splitr took the awkwardness out of splitting bills with roommates. Everyone can see exactly who owes what, and settling up takes seconds.",
    name: "John",
    image: "/testimonials/profile-icon.png",
    role: "Rental Property Manager",
  },
  {
    quote:
      "The accuracy of Splitr's calculations is what sold me. No more spreadsheets, no more disputes — just clean, reliable numbers every time.",
    name: "Cristiano",
    image: "/testimonials/profile-icon.png",
  ...
  {
    quote:
      "Since we started using Splitr for group trips, tracking shared expenses has never been easier. It's become essential for our travel group.",
    name: "David",
    image: "/testimonials/profile-icon.png",
